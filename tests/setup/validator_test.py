...
Module
    validator_test.py
Info
    Unit tests for GenEfiAppBundleValidator class.
'''
...
class TestGenEfiAppBundleValidator(unittest.TestCase):
    ...
    def test_validate_bundle_none(self) -> None:
        with self.assertRaises(Exception):
            GenEfiAppBundleValidator.validate(None)

    def test_validate_bundle_invalid_type(self) -> None:
        with self.assertRaises(Exception):
            GenEfiAppBundleValidator.validate("invalid_bundle")
    ...
    def test_is_valid_success(self) -> None:
        ...
        self.assertTrue(GenEfiAppBundleValidator.is_valid(bundle))

    def test_is_valid_failure(self) -> None:
        self.assertFalse(GenEfiAppBundleValidator.is_valid(None))
        self.assertFalse(GenEfiAppBundleValidator.is_valid("invalid"))
